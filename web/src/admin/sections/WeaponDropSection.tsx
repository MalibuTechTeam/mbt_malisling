...
export function DropLoggingSection({ config, update }: SectionProps) {
  ...
  return (
    <Section icon="clipboard" title="DROP LOGGING" sub="Audit weapon drops to a Discord webhook.">
      <ToggleRow title="Enable Logging" desc="Log weapon drops (death / throw / manual) to Discord"
