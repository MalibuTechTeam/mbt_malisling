RegisterLocale('en', {
    ...
    ['concealed_already_hidden_title'] = 'Concealed Carry',
    ['concealed_already_hidden_desc']  = 'Already out of sight — your job already hides it.',
    ['concealed_reveal_no_lane_title'] = 'Concealed Carry',
    ['concealed_reveal_no_lane_desc']  = 'Revealed, but there\'s no room on your body for it right now.',
