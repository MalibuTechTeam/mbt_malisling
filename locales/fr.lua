RegisterLocale('fr', {
    ...
    ['concealed_already_hidden_title'] = 'Port Dissimulé',
    ['concealed_already_hidden_desc']  = 'Déjà hors de vue — votre travail la cache déjà.',
    ['concealed_reveal_no_lane_title'] = 'Port Dissimulé',
    ['concealed_reveal_no_lane_desc']  = 'Révélée, mais il n\'y a pas de place sur vous pour la montrer maintenant.',
