RegisterLocale('it', {
    ...
    ['concealed_already_hidden_title'] = 'Porto Occulto',
    ['concealed_already_hidden_desc']  = 'Già fuori vista — il tuo lavoro la nasconde già.',
    ['concealed_reveal_no_lane_title'] = 'Porto Occulto',
    ['concealed_reveal_no_lane_desc']  = 'Rivelata, ma al momento non c\'è posto sul corpo per mostrarla.',
